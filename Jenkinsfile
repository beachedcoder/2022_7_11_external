...
//        e.g https://github.com/beachedcoder/2022_7_11_external.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-july2022-user200
//      docker_hub  //id of your global docker credentials in Jenkins https://www.google.com/search?q=add+docker+credentials+Jenkins&oq=add+docker+credentials+Jenkins
//      https://github.com/beachedcoder/2022_7_11_external.git
//      beachcoder
//      external
//      [CLUSTER_NAME] 
    ...
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'master',
                    url: 'https://github.com/beachedcoder/2022_7_11_external.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials [CLUSTER_NAME] --zone [ZONE] --project roidtc-july2022-user200'
            }
        }     
         stage('update k8s') {
             agent {
